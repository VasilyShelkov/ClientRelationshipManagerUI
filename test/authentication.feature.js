...
Scenario('User is redirected to login when not logged in', function(I) {
  ...
  I.seeElement('[data-testid="email-field"]');
});

Scenario('User is taken to their profile after logging in by default', function(
  I,
) {
  I.login();
...
[
  ...
  Scenario(`User is taken to ${url} after being redirected to login`, function(
    I,
  ) {
